...
# 定义形状位置
shapes = [
    ('circle', '#FF6B6B', '圆形', 120, 200, 60),
    ('square', '#4ECDC4', '方形', 340, 200, 60),
    ('triangle', '#FFE66D', '三角形', 560, 200, 70),
    ('ellipse', '#95E1D3', '椭圆形', 780, 200, 80)
]
...
# 添加标题
draw.text((280, 30), "找找生活中的图形", fill='#333333')
